...
"""
model.recbole.data.dataloader.knowledge_dataloader
################################################
"""
from model.recbole.data.dataloader.abstract_dataloader import AbstractDataLoader
from model.recbole.data.dataloader.general_dataloader import TrainDataLoader
from model.recbole.data.interaction import Interaction
from model.recbole.utils import InputType, KGDataLoaderState
...
class KnowledgeBasedDataLoader(AbstractDataLoader):
    ...
    In different states, :meth:`~_next_batch_data` will return different :class:`~model.recbole.data.interaction.Interaction`.
    ...
    Attributes:
        state (KGDataLoaderState):
            This dataloader has three states:
                ...
                - :obj:`~model.recbole.utils.enum_type.KGDataLoaderState.RS`
                - :obj:`~model.recbole.utils.enum_type.KGDataLoaderState.KG`
                - :obj:`~model.recbole.utils.enum_type.KGDataLoaderState.RSKG`
