...
"""
model.recbole.data.dataloader.abstract_dataloader
################################################
"""
...
from model.recbole.utils import InputType, FeatureType, FeatureSource


class AbstractDataLoader:
    """:class:`AbstractDataLoader` is an abstract object which would return a batch of data which is loaded by
    :class:`~model.recbole.data.interaction.Interaction` when it is iterated.
