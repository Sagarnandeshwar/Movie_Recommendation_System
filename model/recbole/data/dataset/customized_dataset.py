...
"""
model.recbole.data.customized_dataset
##################################
...
from model.recbole.data.dataset import KGSeqDataset, SequentialDataset
from model.recbole.data.interaction import Interaction
from model.recbole.sampler import SeqSampler
from model.recbole.utils.enum_type import FeatureType
...
class DIENDataset(SequentialDataset):
    """:class:`DIENDataset` is based on :class:`~model.recbole.data.dataset.sequential_dataset.SequentialDataset`.
    ...
    Attributes:
        augmentation (bool): Whether the interactions should be augmented in model.recbole.
        seq_sample (model.recbole.sampler.SeqSampler): A sampler used to sample negative item sequence.
