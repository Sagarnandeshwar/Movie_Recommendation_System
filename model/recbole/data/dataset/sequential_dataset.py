...
"""
model.recbole.data.sequential_dataset
###############################
"""
...
from model.recbole.data.dataset import Dataset
from model.recbole.data.interaction import Interaction
from model.recbole.utils.enum_type import FeatureType, FeatureSource


class SequentialDataset(Dataset):
    """:class:`SequentialDataset` is based on :class:`~model.recbole.data.dataset.dataset.Dataset`,
    ...
    def build(self):
        ...
        Args:
            eval_setting (:class:`~model.recbole.config.eval_setting.EvalSetting`):
