...
from model.recbole.model.abstract_recommender import SequentialRecommender
from model.recbole.model.layers import TransformerEncoder, FeatureSeqEmbLayer, VanillaAttention
from model.recbole.model.loss import BPRLoss


class FDSA(SequentialRecommender):
    r"""
    FDSA is similar with the GRU4RecF implemented in model.recbole, which uses two different Transformer encoders to
