...
from model.recbole.data.dataloader import FullSortEvalDataLoader
from model.recbole.evaluator import Evaluator, Collector
from model.recbole.utils import ensure_dir, get_local_time, early_stopping, calculate_valid_score, dict2str, \
...
class Trainer(AbstractTrainer):
    ...
    def __init__(self, config, model):
        ...
        saved_model_file = '{}{}.pth'.format("BPR", config["version"])
    ...
    def _train_epoch(self, train_data, epoch_idx, loss_func=None, show_progress=False):
        ...
        total_loss = None
        iter_data = (tqdm(train_data, desc=set_color(f"Train {epoch_idx:>5}", 'pink'),) 
